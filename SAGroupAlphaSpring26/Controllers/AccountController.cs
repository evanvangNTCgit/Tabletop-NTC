...
namespace SAGroupAlphaSpring26.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(DataService dataService, ILogger<AccountController> log)
        {
        ...
        public IActionResult Register(RegisterViewModel rvm)
        {
            ...
            {
                _logger.LogInformation($"Exception on register attempt. {ex.Message}");
        ...
        public async Task<IActionResult> Login(LoginViewModel loginViewModel, string? returnUrl)
        {
            try
            {
                ...
                if (passwordVerificationResult == PasswordVerificationResult.Failed)
                {
                    ...
                    _logger.LogInformation($"Failed login for user: Email: {user.Email} First Name: {user.FirstName}. At {DateTime.Now}");
            ...
            {
                _logger.LogInformation($"Exception on sign in attempt. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            {
                _logger.LogInformation($"User: {User.FindFirst(ClaimTypes.Email)!.Value} failed to logout. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
        ...
        public async Task<IActionResult> Edit()
        {
            ...
            {
                _logger.LogError($"Error generating edit profile view for User. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
        ...
        public async Task<IActionResult> Edit(EditProfileViewModel editViewModel)
        {
            ...
            {
                _logger.LogInformation($"Error saving edit profile changes for user: {editViewModel.EmailAddress}. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
        ...
        public IActionResult ChangePassword(ChangePasswordViewModel viewModel)
        {
            ...
            {
                _logger.LogInformation($"Failed to save password changes for user: {user.Email}. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
        ...
        public IActionResult ChangeUserCurrency([FromBody] UserCurrencyDTO userCurrencyChange)
        {
            ...
            {
                _logger.LogInformation($"Failed to change currency information for user: {userCurrencyChange.UserEmail}. {ex.Message}");
                return RedirectToAction("Index", "Home");
            }
        }
    }
